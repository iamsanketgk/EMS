...
newUserBtn.addEventListener('click', ()=> {
    ...
    modalTitle.innerText = "Enter Employee Details"
    isEdit = false
    imgInput.src = "https://media.istockphoto.com/id/1330180806/vector/blue-sign-design-for-photo-placeholder-on-app-design-user-interface-design-avatar-placeholder.jpg?s=612x612&w=0&k=20&c=jMgBjBh-shvWi0ojpkHSMFnTS9vLXFBKws_VLFhK2eo="
    form.reset()
})
...
form.addEventListener('submit', (e)=> {
    ...
    submitBtn.innerText = "Submit"
    modalTitle.innerHTML = "Enter Employee Details"
